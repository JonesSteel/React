...
class UserController extends ApiController
{
    ...
    public function authenticate(Request $request)
    {
        ...
        if ($validator->fails())
        {
            return $this->respondWithValidationError('Fields Validation Failed.', $validator->errors());
        } else {
    ...
    public function register(Request $request)
    {
        ...
        if ($validator->fails())
        {
            return $this->respondValidationError('Field Validation Failed.', $validator->errors());
        } else {
            $user = User::create([
                'name' => $request['name'],
                'email' => $request['email'],
            ...
            return $this-> _login($request['email'], $request['passowrd']);
        }
    }
    ...
    public function logout($api_token)
    {
        try {
            ...
            return $this->respondInternalError("An error occurred while perming an action!");
        }
    }
}
